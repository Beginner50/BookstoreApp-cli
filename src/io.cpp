...
namespace IO
{
    ...
    bool validProfileChoice(char ch)
    {
        switch (ch)
        {
        case 'u':
    ...
    void displayInvalidInputErrorMessage()
    {
        std::cout << "Invalid input!\n";
    }

    BookActions charToBookActions(char ch)
    {
        switch (ch)
        {
        case 'a':
    ...
    AuthActions charToAuthActions(char ch)
    {
        switch (ch)
        {
        case 'l':
    ...
    ProfileActions charToProfileActions(char ch)
    {
        switch (ch)
        {
        case 'u':
